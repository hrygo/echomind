...
## 🗓️ Phase 2: 智能分析与双视图构建 (Alpha) - 🚧 In Progress
...
*   **用户界面**
    ...
    *   [ ] **任务看板**：展示从邮件中提取的待办事项。
*   **技术基建**
    *   [ ] 完善 AI 输出结构化 (JSON Output)。
    *   [ ] 引入消息队列 (Redis/Kafka) 异步处理 AI 任务 (已引入 Asynq)。
...
*   **高级功能**
    *   [ ] **人脉价值图谱**：可视化展示联系人网络及交互热度。
    *   [ ] **意图雷达 (Intent Radar)**：自动识别购买/合作/会议意图。
    *   [ ] **关系热度图**：可视化联系人互动频率及冷暖。
    *   [ ] **智能草稿**：基于意图自动生成回复。
    *   [ ] **情绪雷达**：高亮 "愤怒/紧急" 邮件。
*   **生态集成**
