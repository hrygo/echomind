...
func (m *MockMailbox) SearchMessages(uid bool, criteria *imap.SearchCriteria) ([]uint32, error) { return []uint32{1}, nil }
func (m *MockMailbox) Expunge() error { return nil }
func (m *MockMailbox) UpdateMessagesFlags(uid bool, seqset *imap.SeqSet, operation imap.FlagsOp, flags []string) error { return nil }
func (m *MockMailbox) CopyMessages(uid bool, seqset *imap.SeqSet, dest string) error { return nil }
func (m *MockMailbox) CreateMessage(flags []string, date time.Time, body imap.Literal) error { return nil }